			...
			<Body className="bg-offwhite font-sans text-base">
					...
					<Section>
						<Row>
							<Text className="text-base text-gray-800">
								Congratulations! You're joining businesses worldwide that use
								Beauty Nails System to streamline operations and drive success.
							</Text>
				...
				<Container className="mt-20">
					...
					<Text className="mb-45 text-center text-gray-400">
						Beauty Nails System, 123 Business Street, Suite 300, San Francisco,
						CA
					</Text>
				</Container>
			</Body>
