...
async function main() {
	...
	await prisma.salonProfile.upsert({
		...
		create: {
			...
			name: "Beauty Nails",
			address:
				"Q. Himbi, Av. de la Justice, Goma, Republique Démocratique du Congo",
			phone: "+243 810 000 000",
			email: "contact@beautynails.cd",
			website: "https://www.beautynails.cd",
			description:
				"Votre salon de beauté de référence à Republique Démocratique du Congo. Nous offrons une large gamme de services de manucure, pédicure, soins du visage et plus encore. Notre équipe de professionnels passionnés est dédiée à vous offrir une expérience de beauté exceptionnelle dans un environnement chaleureux et accueillant.",
