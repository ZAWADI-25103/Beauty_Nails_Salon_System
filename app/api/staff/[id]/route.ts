...
export async function GET(
	...
	try {
		...
		const formattedStaff = {
			...
			commissionFrequency: staff?.commissionFrequency,
			commissionDay: staff?.commissionDay,
			minimumPayout: staff?.minimumPayout,
			lastCommissionPaidAt: staff?.lastCommissionPaidAt,
			rating: staff?.rating,
