...
async function addHeader(
	...
	doc.text(`Report Period: ${dateRange}`, pageWidth / 2, yPos, {
		align: "center",
	});
	yPos += 15;
...
async function processSection(
	...
	switch (section.type) {
		case "table":
			yPos = await processTableSection(
				doc,
				section,
				pageWidth,
				pageHeight,
