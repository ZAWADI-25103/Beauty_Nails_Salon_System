...
export default function ManageClientMembership({
	clientId,
}: ManageClientMembershipProps) {
	const { purchases, isLoading, error, purchaseMembership, updatePurchase } =
		useMembershipPurchases({ clientId });
	...
	const handleUpgrade = (
		...
		updatePurchase({
			...
			data: {
				...
				status: "active" /*, reset start/end dates */,
			},
		});
	};
					...
					<div className="relative z-10 space-y-5">
						...
						<div className="flex flex-wrap gap-3 pt-2">
							<Button
								...
								variant="secondary"
								onClick={() =>
									handleRenew(activePurchase.id, activePurchase.membershipId)
								}
