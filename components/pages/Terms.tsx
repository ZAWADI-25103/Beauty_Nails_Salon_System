			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<Card className="bg-white dark:bg-gray-950 border-b border-pink-100 dark:border-pink-900 shadow-xl rounded-2xl p-6 sm:p-8 dark:prose-invert prose prose-pink max-w-none">
					...
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">
						...
						WhatsApp. Une confirmation vous sera envoyée par email ou SMS.
					</p>
					...
					<ul className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
						...
						<li>
							Les annulations tardives (moins de 24h) peuvent entraîner des
							frais de 50%
						</li>
					...
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">
						Les prix affichés sont en francs congolais (CDF) et peuvent être
						modifiés sans préavis. Le prix convenu lors de la réservation sera
						respecté.
					</p>
					...
					<ul className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
						...
						<li>
							Suivre les conseils d'entretien donnés après les prestations
						</li>
					</ul>

					<h2 className="text-2xl  sm:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-3 sm:mb-4">
						8. Responsabilités de Beauty Nails
					</h2>
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
						Beauty Nails s'engage à :
					</p>
					<ul className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
						...
						<li>
							Traiter les données personnelles conformément à notre politique de
							confidentialité
						</li>
					</ul>
					...
					<ul className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
						...
						<li>
							Résultats ne correspondant pas aux attentes si les instructions
							d'entretien n'ont pas été suivies
						</li>
						<li>
							Dommages résultant d'une mauvaise utilisation des produits
							recommandés
						</li>
					</ul>
					...
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">
						Toute réclamation doit être formulée dans les 48h suivant la
						prestation. Nous nous efforcerons de trouver une solution
						satisfaisante rapidement.
					</p>

					<h2 className="text-2xl  sm:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-3 sm:mb-4">
						11. Photos et Témoignages
					</h2>
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">
						Avec votre consentement, nous pouvons utiliser des photos de nos
						réalisations à des fins promotionnelles. Vous pouvez retirer votre
					...
					<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">
						Ces conditions sont régies par le droit de la République
						Démocratique du Congo. Tout litige sera soumis aux tribunaux
						compétents de Kinshasa.
					</p>
