			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 ">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
					{contactInfo.map((info, index) => (
						<Card
							key={index}
							className="bg-white dark:bg-gray-950 border-b border-pink-100 dark:border-pink-900 shadow-lg hover:shadow-xl transition-shadow p-6 sm:p-8 rounded-2xl text-center"
						>
							...
							{info.link ? (
								...
								<p className="text-lg sm:text-base text-gray-600 dark:text-gray-300 whitespace-pre-line">
									{info.content}
								</p>
							)}
						</Card>
						...
						<Card className="bg-white dark:bg-gray-950 border-b border-pink-100 dark:border-pink-900 shadow-lg p-6 sm:p-8 rounded-2xl">
							...
							<div className="space-y-3 sm:space-y-4">
								{hours.map((item, index) => (
									<div
										key={index}
										className="flex justify-between text-base sm:text-lg"
									>
					...
					<Card className="bg-white dark:bg-gray-950 border-b border-pink-100 dark:border-pink-900 shadow-xl rounded-2xl overflow-hidden">
						...
						<div className="aspect-video bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
							<div className="text-center text-gray-500 dark:text-gray-400 px-4">
								<iframe
									src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7976.265327690709!2d29.19361407041877!3d-1.6655623737073957!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19dd0f314211f117%3A0x853637f77640d4c0!2sHimbi!5e0!3m2!1sen!2srw!4v1772725988080!5m2!1sen!2srw"
									width="1210"
									height="720"
									style={{
										border: "1",
