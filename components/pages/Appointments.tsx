"use client";
import { Calendar as CalendarIcon, Clock, Home, Sparkles } from "lucide-react";
...
export default function Appointments() {
	...
	const formattedDate = selectedDate
		...
		: "";
	const workerIdForSlots =
		selectedWorker && selectedWorker !== "any" ? selectedWorker : "";
	...
	const availableMap = useMemo(() => {
		...
		return new Map(
			availableSlotsData.slots.map((s: any) => [s.time, s.available]),
		);
	}, [availableSlotsData]);
	...
	const services = {
		...
		cils: [
			{
				id: "extensions-volume-naturel",
				label: "Extensions Volume Naturel (40 000 CDF)",
			},
			{
				id: "extensions-volume-russe",
				label: "Extensions Volume Russe (60 000 CDF)",
			},
			{
				id: "rehaussement-de-cils",
				label: "Rehaussement de Cils (25 000 CDF)",
			},
		],
		tresses: [
		...
		maquillage: [
			...
			{
				id: "maquillage-quotidien",
				label: "Maquillage Quotidien (20 000 CDF)",
			},
		],
	};
	...
	const selectedServiceObj = useMemo(() => {
		...
		return (
			(services as any)[selectedCategory].find(
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<Card className="p-8 border-0 shadow-xl rounded-2xl">
							<div className="flex items-center mb-6">
								...
								<h2 className="text-2xl  text-gray-900">Date et heure</h2>
							</div>

							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div>
									<Label className="text-gray-700 mb-3 block">Date</Label>
									<Calendar
										mode="single"
								...
								<div>
									<Label className="text-gray-700 mb-3 block">Heure</Label>
									<div className="grid grid-cols-3 gap-2">
										{timeSlots.map((time) => {
											const isAvailable = availableMap
												? !!availableMap.get(time)
												: true;
											return (
												<button
													key={time}
						...
						<Card className="p-8 border-0 shadow-xl rounded-2xl">
							<div className="flex items-center mb-6">
								...
								<h2 className="text-2xl  text-gray-900">Lieu du rendez-vous</h2>
							</div>
								...
								<div className="space-y-4">
									<div className="flex items-center space-x-3 p-4 border-2 border-gray-200 rounded-xl hover:border-pink-300 transition-colors">
										...
										>
											...
											<div>
												<p className="text-gray-900">Au salon</p>
									...
									<div className="flex items-center space-x-3 p-4 border-2 border-gray-200 rounded-xl hover:border-pink-300 transition-colors">
										...
										>
											...
											<div>
												<p className="text-gray-900">À domicile</p>
												<p className="text-lg text-gray-500">
							...
							<div className="space-y-4 mb-6">
								{selectedService && (
									<div className="pb-4 border-b border-gray-200">
										<p className="text-lg text-gray-500 mb-1">Service</p>
								...
								<div className="mt-2 text-base text-gray-400">
									<p>
										Lien de réservation:{" "}
										<span className="break-all">{reserveHref}</span>
									</p>
								</div>

								{selectedWorker && (
									<div className="pb-4 border-b border-gray-200">
										<p className="text-lg text-gray-500 mb-1">Spécialiste</p>
										<p className="text-gray-900">{selectedWorker}</p>
									</div>
								)}

								{selectedDate && selectedTime && (
									<div className="pb-4 border-b border-gray-200">
										<p className="text-lg text-gray-500 mb-1">Date et heure</p>
								...
								<div className="pb-4 border-b border-gray-200">
									<p className="text-lg text-gray-500 mb-1">Lieu</p>
									<div className="flex items-center text-gray-900">
										{location === "salon" ? (
											<>
								...
								{addOns.length > 0 && (
									<div className="pb-4">
										<p className="text-lg text-gray-500 mb-2">Options</p>
										<ul className="space-y-1">
											{addOns.map((addon) => (
												<li key={addon} className="text-lg text-gray-700">
													• {addon}
												</li>
											))}
										</ul>
