...
import { ArrowLeft, Clock, DollarSign, Loader2, Star } from "lucide-react";
								...
								>
									<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
										<div className="lg:col-span-2">
											<h3 className="text-2xl text-gray-900 dark:text-gray-100 mb-3 font-medium">
												{service.name}
											</h3>
												...
												<div>
													...
													<ul className="space-y-1">
														{service.addOns.map((addon, i) => (
															<li
																key={i}
																className="text-lg text-gray-600 dark:text-gray-300 flex items-center"
															>
