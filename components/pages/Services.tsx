...
import { Clock, DollarSign, Loader2, Sparkles } from "lucide-react";
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
						...
						Chaque prestation est réalisée par nos expertes dans un
						environnement luxueux et relaxant.
					</p>
				</div>
									...
									{hasServices ? (
										<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
											{categoryServices.map((service) => (
												...
												>
													<h3 className="text-xl text-gray-900 dark:text-gray-100 mb-4 font-medium">
														{service.name}
													</h3>
