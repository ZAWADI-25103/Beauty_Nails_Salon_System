			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
						<div className="text-center lg:text-left">
							<div className="flex items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-3 sm:mb-4">
								<div className="text-6xl sm:text-7xl text-gray-900 dark:text-gray-100">
									{stats.averageRating}
								</div>
								<div className="flex">
									{[...Array(5)].map((_, i) => (
										<Star
											key={i}
											className="w-6 h-6 sm:w-8 sm:h-8 fill-amber-400 text-amber-400"
										/>
									))}
								</div>
							</div>
							<p className="text-xl sm:text-2xl text-gray-700 dark:text-gray-200 mb-1 sm:mb-2">
								Note moyenne
							</p>
							<p className="text-lg sm:text-base text-gray-600 dark:text-gray-400">
								Basée sur {stats.totalReviews} avis vérifiés
							</p>
							<a
							...
							>
								<Button
									variant="outline"
									className="border-pink-200 dark:border-pink-800 text-pink-600 dark:text-pink-400 hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-full text-lg sm:text-base"
								>
									Voir sur Trustpilot
								</Button>
							</a>
							...
							{[5, 4, 3, 2, 1].map((stars) => {
								...
								return (
									<div key={stars} className="flex items-center gap-3 sm:gap-4">
										<span className="text-base sm:text-lg text-gray-700 dark:text-gray-300 w-12">
										...
										<span className="text-base sm:text-lg text-gray-600 dark:text-gray-400 w-8 text-right">
											{count}
										</span>
									</div>
								);
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
					{testimonials.map((testimonial, index) => (
						<Card
							key={index}
							className="bg-white dark:bg-gray-950 border-0 border-b border-pink-100 dark:border-pink-900 shadow-lg hover:shadow-xl transition-shadow p-4 sm:p-6 rounded-2xl"
						>
							<div className="flex items-center justify-between mb-3 sm:mb-4">
								...
								{testimonial.verified && (
									<Badge className="bg-green-500 text-white text-base px-2 py-0.5">
										Vérifié
									</Badge>
								)}
							</div>
							...
							<div className="relative mb-3 sm:mb-4">
								...
								<p className="text-lg sm:text-base text-gray-700 dark:text-gray-300 pl-4 sm:pl-6">
									{testimonial.text}
								</p>
							</div>
				...
				<div className="bg-linear-to-br from-pink-500 via-purple-500 to-amber-500 rounded-3xl p-6 sm:p-12 text-center text-white">
					...
					<p className="text-base sm:text-xl text-pink-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
						Découvrez pourquoi Beauty Nails est le salon de beauté préféré des
						femmes de Kinshasa
					</p>
					<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
						<Link href="/appointments">
							<Button
								size="lg"
								className="w-full sm:w-auto bg-white text-pink-600 hover:bg-gray-100 rounded-full px-6 sm:px-8 py-5 sm:py-6 text-lg sm:text-base"
							>
								Réserver maintenant
							</Button>
						</Link>
						<Link href="/services">
							<Button
								size="lg"
								variant="outline"
								className="w-full sm:w-auto border-2 border-white text-white hover:bg-white/10 rounded-full px-6 sm:px-8 py-5 sm:py-6 text-lg sm:text-base"
							>
								Voir nos services
							</Button>
						</Link>
