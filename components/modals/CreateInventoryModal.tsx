				...
				<div className="p-8 space-y-8">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
						<div className="col-span-2 md:col-span-1">
							...
							<Input
								type="number"
								className="h-12 rounded-xl font-mono text-lg bg-emerald-50/50 dark:bg-emerald-950/20 border-emerald-100 dark:border-emerald-900"
								value={cost}
								onChange={(e) =>
					...
					<div className="p-6 bg-gray-50 dark:bg-white/5 rounded-[2rem] grid grid-cols-3 gap-6">
						<div>
							...
							<Input
								type="number"
								className="h-12 rounded-xl bg-white dark:bg-gray-900 border-0 shadow-sm"
								value={initialStock}
								onChange={(e) =>
									setInitialStock(
