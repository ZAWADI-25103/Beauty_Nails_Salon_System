import { AlertTriangle, Barcode, Image as ImageIcon, Scan } from "lucide-react";
					...
					<TabsContent value="details" className="space-y-4 pt-4">
						...
						<div className="flex justify-center mb-4">
							<div className="w-40 h-40 sm:w-48 sm:h-48 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 hover:border-pink-300 transition-colors">
								...
								<span className="text-lg sm:text-base text-gray-500 mt-2">
									Ajouter Photo
								</span>
							</div>
						</div>
						...
						<div className="space-y-2">
							...
							<div className="relative">
								<Input
									...
									className="pl-10 h-12 text-base"
								/>
								<span className="absolute left-3 top-3.5 text-lg text-gray-500">
									CDF
								</span>
							</div>
						</div>
					...
					<TabsContent value="inventory" className="space-y-4 pt-4">
						<div className="bg-orange-50 p-3 rounded-lg border border-orange-100 flex items-start gap-3">
							...
							<div className="text-lg text-orange-800">
								Définissez le seuil d'alerte pour recevoir des notifications
								automatiques lorsque le stock est bas.
							</div>
						</div>
...
export function AdjustStockModal({
	...
	const handleSubmit = () => {
		...
		const operation = ["damage", "usage", "correction_neg"].includes(reason)
			? "remove"
			: "add";
			...
			<DialogContent className="sm:max-w-md w-[95vw] p-4 sm:p-6">
				...
				<div className="space-y-4">
					...
					<div className="space-y-2">
						<Label className="text-lg sm:text-base">
							Quantité à{" "}
							{["damage", "usage", "correction_neg"].includes(reason)
								? "retirer"
								: "ajouter"}
						</Label>
						<Input
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						...
						<div className="space-y-2">
							...
							<div className="relative">
								...
								/>
								<span className="absolute right-3 top-3 text-base sm:text-lg text-gray-500">
									CDF
								</span>
							</div>
						</div>
