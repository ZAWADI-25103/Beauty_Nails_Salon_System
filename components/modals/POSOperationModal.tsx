...
export default function POSOperationModal({
	triggerLabel = "Opération POS",
}: {
	triggerLabel?: string;
}) {
	...
	const [items, setItems] = useState<
		Array<{ serviceId: string; quantity: number; price: number }>
	>([]);
	...
	const onSubmit = () => {
		...
		const payload: any = {
			...
			loyaltyPointsUsed:
				loyaltyPoints === "" ? undefined : Number(loyaltyPoints),
			...
			<DialogContent className="sm:max-w-2xl w-[95vw] max-h-[90vh] overflow-y-auto p-4 sm:p-6">
				...
				<div className="grid grid-cols-1 gap-4 py-4">
					...
					<div className="grid grid-cols-1 gap-2">
						<div>
							<Label htmlFor="pos-appointment" className="text-lg">
						...
						<div>
							<Label htmlFor="pos-client" className="text-lg">
								Client ID (optionnel)
							</Label>
							<Input
								id="pos-client"
					...
					<div className="grid grid-cols-1 gap-2">
						<div>
							<Label htmlFor="pos-item-service" className="text-lg">
								ID Service/Produit
							</Label>
							<Input
								id="pos-item-service"
						...
						<div className="grid grid-cols-2 gap-2">
							<div>
								<Label htmlFor="pos-item-price" className="text-lg">
									Prix
								</Label>
								<Input
									id="pos-item-price"
							...
							<div>
								<Label htmlFor="pos-item-qty" className="text-lg">
									Quantité
								</Label>
								<Input
									id="pos-item-qty"
					...
					<div className="grid grid-cols-1 gap-2">
						<div>
							<Label htmlFor="pos-method" className="text-lg">
								Méthode
							</Label>
							<select
								id="pos-method"
						...
						<div>
							<Label htmlFor="pos-discount" className="text-lg">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
							...
							<div>
								<Label htmlFor="pos-tip" className="text-lg">
									Pourboire (optionnel)
								</Label>
								<Input
									id="pos-tip"
									...
									value={tip}
									onChange={(e) =>
										setTip(e.target.value === "" ? "" : Number(e.target.value))
									}
									className="h-11 text-base"
								/>
							</div>
