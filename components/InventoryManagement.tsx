...
export default function InventoryManagement() {
	...
	const inventory: InventoryItem[] = useMemo(() => {
		if (apiInventory && apiInventory.length)
			return apiInventory as unknown as InventoryItem[];
		return [];
	}, [apiInventory]);
							...
							>
								...
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
									...
									<div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700">
										...
										<p className="text-base sm:text-lg font-medium text-gray-700 dark:text-gray-300 break-all">
											{supplier.email}
										</p>
									</div>
								</div>
								...
								<div className="mb-8">
									<p className="text-base  text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-3">
										Produits fournis
									</p>
									<div className="flex flex-wrap gap-2">
										{supplier.products.map((product, idx) => (
											<Badge
												key={idx}
												variant="outline"
												className="text-[10px] sm:text-base px-3 py-1 dark:border-gray-700 dark:text-gray-300 bg-white dark:bg-gray-950"
											>
												{product}
											</Badge>
										))}
