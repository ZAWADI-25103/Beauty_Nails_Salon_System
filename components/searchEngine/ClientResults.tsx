...
import { Gift, Star, User, Wallet } from "lucide-react";
	...
	return (
		<div className="p-5 border border-pink-100 dark:border-pink-900 rounded-2xl shadow-md bg-white dark:bg-gray-950 hover:shadow-lg transition">
			...
			<div className="flex justify-between items-start">
				...
				{/* Tier Badge */}
				<span
					className={`px-3 py-1 rounded-full text-xs  ${client.tier === "Regular" ? "bg-gray-100 text-gray-700" : client.tier === "VIP" ? "bg-purple-100 text-purple-700" : "bg-yellow-100 text-yellow-700"}`}
				>
					{client.tier}
				</span>
			</div>
