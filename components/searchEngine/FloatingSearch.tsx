	...
	const filtered = {
		appointments: appointments?.filter(
			(a: Appointment) =>
				...
				a.worker?.user?.name.toLowerCase().includes(query.toLowerCase()) ||
				a.client?.user?.name.toLowerCase().includes(query.toLowerCase()),
		),
		payments: payments?.filter((p: any) => p.transactionId?.includes(query)),
