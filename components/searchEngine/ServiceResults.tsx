				...
				>
					...
					<p className="text-sm text-gray-500 mt-1">
						...
						<span className="text-gray-500 dark:text-white">
							{service.category?.toUpperCase() || "N/A"}
						</span>
					</p>
					...
					<div className="mt-3 space-y-2">
						...
						<div className="w-full">
							<Link href={"/appointments?service=" + service.id}>
								<Button
									size={"sm"}
									className="w-full bg-linear-to-r from-gray-900 via-pink-700 to-pink-500 hover:scale-[1.02] transition-all duration-300 ease-out text-white rounded-2xl py-4 text-lg font-medium shadow-xl"
								>
									Réserver
								</Button>
							</Link>
