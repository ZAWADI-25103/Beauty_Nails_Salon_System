...
export default function FloatingBubbles({
	...
	const successfulReferrals =
		referralList?.filter(
			(r: any) => r.status === "completed" || r.status === "pending",
		).length || 0;
			...
			<AnimatePresence>
				...
				{(canClaimBonus || hasActiveBonus) && (
                  ...
                  `}
							...
							<PopoverContent
								side="left"
								className="w-64 bg-linear-to-br from-purple-50 to-pink-50 dark:from-gray-950 dark:to-gray-950 p-4 rounded-2xl text-center shadow-sm hover:shadow-lg transition border border-pink-100 hover:border-pink-400 dark:border-pink-900 dark:hover:border-pink-400"
							>
								{canClaimBonus ? (
								...
								<PopoverContent className="w-64 bg-linear-to-br from-purple-50 to-pink-50 dark:from-gray-950 dark:to-gray-950 p-4 rounded-2xl text-center shadow-sm hover:shadow-lg transition border border-pink-100 hover:border-pink-400 dark:border-pink-900 dark:hover:border-pink-400">
									<div className="space-y-2">
										...
										<div className="flex justify-between text-sm">
											<span>Prix</span>
											<span className="font-medium">{appt.price} CDF</span>
										</div>
