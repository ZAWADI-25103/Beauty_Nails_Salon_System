import { Eye, Info, Package, ShoppingCart } from "lucide-react";
...
const statusStyles = {
	out_of_stock:
		"border-red-500/30 bg-linear-to-br from-white to-red-50/50 dark:from-gray-900 dark:to-red-950/20 text-red-600",
	critical:
		"border-orange-500/30 bg-linear-to-br from-white to-orange-50/50 dark:from-gray-900 dark:to-orange-950/20 text-orange-600",
...
export const InventoryCard = ({ item }: { item: InventoryItem }) => {
	...
	return (
		<Card
			key={item.id}
			className={`group relative overflow-hidden border-0 shadow-2xl transition-all duration-300 hover:-translate-y-1 rounded-3xl ${style}`}
		>
				...
				<div className="flex items-start justify-between gap-4 mb-6">
					...
					<div className="text-right">
						<span className="text-2xl font-black tracking-tight text-gray-900 dark:text-white">
							...
							<small className="text-xs font-medium opacity-60">CDF</small>
						</span>
					</div>
				</div>
